...
A progressive collection of 21 examples showcasing the AXIS programming language — from basic output to compiled native binaries.
...
| 09 | `functions.axis` | Functions | `func`, `return`, return types, recursion |
...
| 19 | `guessing_game.axis` | Guessing Game | `input()`, interactive I/O |
| 20 | `compile_mode.axis` | Compile Mode | `mode compile`, `main() -> i32`, native binary |

## Language Features Demonstrated

- **I/O**: `write()`, `writeln()`, `input()`, `input("prompt")`
